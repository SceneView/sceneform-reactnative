...
class AnchorsView extends React.Component {
    constructor() {
        super();
...
const NativeArView = requireNativeComponent('SceneformView', AnchorsView, {
    nativeOnly: { onChange: true }
});

module.exports = AnchorsView;